      ...
      <div class="main-sidebar">
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.html">RENTAL MOBIL FIKSRIOTS</a>
          </div>
          ...
          <ul class="sidebar-menu">
              ...
              <li><a class="nav-link" href="<?php echo base_url('admin/Laporan') ?>"><i class="fas fa-clipboard-list"></i> <span>Laporan</span></a></li>
               <li><a class="nav-link" href="<?php echo base_url('auth/ganti_password') ?>"><i class="fas fa-sign-out-alt"></i> <span>Change Password</span></a></li>
